...
function Summery({ enabledNext }) {
    ...
    const GenerateSummeryFromAI = async () => {
        ...
        console.log(responseText);  // Log the response to check its structure
                ...
                <form className='mt-7' onSubmit={onSave}>
                    <div className='flex justify-between items-end'>
                        ...
                        <Button variant="outline" onClick={GenerateSummeryFromAI}
                            type="button" size="sm" className="border-emerald-400 text-emerald-400 flex gap-2">
                ...
                <div className='my-5'>
                    ...
                    {aiGeneratedSummeryList.map((item, index) => (
                        <div key={index}
                            ...
                            <h2 className='font-bold my-1 text-emerald-400'>Level: {item?.experience_level}</h2>
                            <p>{item?.summary}</p>
                        </div>
                    ))}
                </div>
