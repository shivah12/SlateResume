  ...
  return (
    <div className=''>
      <Link to={'/dashboard/resume/' + resume.documentId + "/edit"}>
        <div className='p-14 bg-gradient-to-b from-emerald-400 via-emerald-200 to-white h-[240px] rounded-t-lg border-t-4'
          style={{
            borderColor: resume?.themeColor
          }}
        >
          <div className='flex items-center justify-center h-[180px] '>
            <img src="/cv.png" width={80} height={80} alt="Resume Thumbnail" />
          </div>
        </div>
      </Link>
      <div className='border p-3 flex justify-between text-black rounded-b-lg shadow-lg'
        ...
        <h2 className='text-sm color-black'>{resume.title}</h2>
        <DropdownMenu>
          <DropdownMenuTrigger>
